   ...
   <header>
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item active" style="background-image: url('vendor/img/slide_2.jpg')"></div>

            <div class="carousel-item" style="background-image: url('vendor/img/slide01.jpeg')"></div>

            <div class="carousel-item" style="background-image: url('vendor/img/p_banner1.jpg')"></div>
    ...
    <div class="container">
        ...
        <h1 class="my-4">Welcome to SRS-KEKE Park Online Booking System</h1>
